...
<script type='text/javascript'>
    ...
    window.location='administrador.php?p=docente/consultar_d_a';
</script>
<?php
} 
...
<legend><h3 class="text-center"><b>CONSULTAR PERSONAL DOCENTE</b></h3></legend>
<form action="" method="POST" >
  ...
  ?>
        ...
        <div class="col-xs-2">
            ...
            <input disabled name="f_naci" id="f_naci" type="date" title="Fecha de Nacimiento" class="form-control input-sm"  required value="<?=$fila[4]?>">
          </div>

          <div class="col-xs-1">
            <label for="edad">Edad</label>
            <input disabled name="edad" id="" type="text" maxlength="2" class="form-control input-sm" title="Edad"  required oninput="check_edad(this);" value="<?=$edad?>">
          </div>
