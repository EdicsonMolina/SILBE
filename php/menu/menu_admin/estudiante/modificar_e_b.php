...
<legend><h3 class="text-center"><b>MODIFICAR ESTUDIANTE</b></h3></legend>
<form action="administrador.php?p=estudiante/modificar_e_c" method="POST">
    ...
    <div class="container">
      <div class="row">
          ...
          <div class="col-xs-2">
            ...
            <input name="ced_e" maxlength="8" onkeypress="return solonumeros(event)" onpaste="return false" id="ced_e" type="text" class="form-control input-sm" placeholder="N° de documento" title="N° de documento" pattern="[0-9]{7,8}$" required oninput="check_ced_r(this);" value="<?=$fila[0]?>">
          </div>

          <div class="col-xs-2">
            <label for="nombre">Nombre</label>
            <input  maxlength="50" onkeypress="return sololetras(event)" onpaste="return false" name="nombre" id="nombre" type="text" class="form-control input-sm" placeholder="Nombre" title="Nombre" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚüÜ]{2,15}\s?)*" required oninput="check_nombre(this);" value="<?=$fila[3]?>">
          </div>

          <div class="col-xs-2">
            <label for="apellido">Apellido</label>
            <input  maxlength="50" onkeypress="return sololetras(event)" onpaste="return false" name="apellido" id="apellido" type="text" class="form-control input-sm" placeholder="Apellido" title="Apellido" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚüÜ]{2,15}\s?)*"  required oninput="check_apellido(this);" value="<?=$fila[4]?>">
          </div>
          ...
          <div class="col-xs-2">
            ...
            <input name="f_naci" id="f_naci" type="date" onpaste="return false" title="Fecha de Nacimiento" class="form-control input-sm" required value="<?=$fila[7]?>">
          </div>
  ...
  <div class="container">
      <div class="row">
          ...
          <div class="col-xs-2">
            ...
            <input  maxlength="50" onkeypress="return sololetras(event)" onpaste="return false" name="area_aten" id="area_aten" title="area_aten" type="text" class="form-control input-sm" placeholder="Area de atención" title="Area de Atención" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚüÜ#-]\s?)*" required oninput="check_area_aten(this);" value="<?=$fila[12]?>">
          </div>

           <div class="col-xs-2">
            <label for="progra_apoy">Programa de Apoyo</label>
            <input  maxlength="50" onkeypress="return sololetras(event)" onpaste="return false" name="progra_apoy" id="progra_apoy" type="text" class="form-control input-sm" placeholder="Programa de Apoyo" title="Programa de Apoyo" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚüÜ#-]\s?)*" required oninput="check_progra_apoy(this);" value="<?=$fila[13]?>">
          </div>
    </div>
    </div><br>
    ...
    <div class="container">
      <div class="row">
          ...
          <div class="col-xs-2">
            ...
            <select name="parro" id="parroquia" title="Seleccione Parroquia" class="form-control input-sm" required>
          ...
          <div class="col-xs-2">
            ...
            <input  maxlength="30" onkeypress="return sololetras(event)" onpaste="return false" name="pobla" id="pobla" type="text" class="form-control input-sm" placeholder="Población" title="Población" pattern="([0-9a-zA-ZñÑáéíóúÁÉÍÓÚüÜ#-]\s?)*" required  oninput="check_pobla(this);" value="<?=$fila[16]?>">
          </div>

          <div class="col-xs-3">
            <label for="urbani">Urbanización</label>
            <input  maxlength="30" onkeypress="return sololetras(event)" onpaste="return false" name="urbani" id="urbani" type="text" class="form-control input-sm" placeholder="Urbanización" title="Urbanización" pattern="([0-9a-zA-ZñÑáéíóúÁÉÍÓÚüÜ#]\s?)*" required oninput="check_urbani(this);" value="<?=$fila[17]?>">
          </div>

          <div class="col-xs-2">
            <label for="via">Tipo de Via</label>
            <input  maxlength="30" onkeypress="return sololetras(event)" onpaste="return false" name="via" id="via" type="text" class="form-control input-sm" placeholder="Tipo de Via" title="Tipo de Vía" pattern="([0-9a-zA-ZñÑáéíóúÁÉÍÓÚüÜ#]\s?)*" required oninput="check_via(this);" value="<?=$fila[18]?>">
          </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-8">
            ...
            <input  maxlength="50" name="direc" id="direc" type="text" class="form-control input-sm" placeholder="Dirección" title="Dirección" pattern="([0-9a-zA-ZñÑáéíóúÁÉÍÓÚüÜ#]\s?)*" required oninput="check_direc(this);" value="<?=$fila[19]?>">
          </div>
    ...
    <div class="container">
      <div class="row">
            ...
            <input name="ser_canaima" onkeypress="return solonumeros(event)" onpaste="return false" id="ser_canaima" type="text" class="form-control input-sm" placeholder="00" title="Serial Canaima"  pattern=[0-9.]* required oninput="" value="<?=$fila[26]?>">
          </div>
            ...
            <input name="ingre_fami" onkeypress="return solonumeros(event)" onpaste="return false" id="ingre_fami" type="text" class="form-control input-sm" placeholder="Ingreso Familiar" title="Ingreso Familiar" pattern="[0-9.]*" required oninput="check_ingre_fami(this);" value="<?=$fila[28]?>">
          </div>
    ...
    <div class="container">
      <div class="row">
          ...
          <div class="col-xs-2">
            ...
            <input name="tele_mov" maxlength="11" onkeypress="return solonumeros(event)" onpaste="return false" id="tele_mov" type="text" class="form-control input-sm" placeholder="04240000000" title="Teléfono Movil"  pattern="[0-9]{11}$" required oninput="check_tele_mov(this);" value="<?=$fila[29]?>">
          </div>

          <div class="col-xs-2">
            <label for="tele_hab">Telefono Habitación</label>
            <input name="tele_hab" maxlength="11" onkeypress="return solonumeros(event)" onpaste="return false" id="tele_hab" type="text" class="form-control input-sm" placeholder="02740000000" title="Teléfono Habitación"  pattern="[0-9]{11}$"  required oninput="check_tele_hab(this);" value="<?=$fila[30]?>">
          </div>

          <div class="col-xs-2">
            <label for="email">Email</label>
            <input name="email" maxlength="30" id="email" type="email" class="form-control input-sm" placeholder="email@email.com" title="Email" pattern="([a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5})*" required oninput="check_email(this);" value="<?=$fila[31]?>">
          </div>

          <div class="col-xs-1">
            <label for="estatura">Estatura</label>
            <input name="estatura" onpaste="return false" id="estatura" type="text" class="form-control input-sm" placeholder="0.00" maxlength="4" title="Estatura"  pattern=[0-9.,]* required oninput="check_estatura(this);" value="<?=$fila[32]?>">
          </div>

          <div class="col-xs-1">
            <label for="peso">Peso</label>
            <input name="peso" onkeypress="return solonumeros(event)" onpaste="return false" id="peso" type="text" class="form-control input-sm" placeholder="00" title="Peso"  pattern=[0-9.]* required oninput="check_peso(this);" value="<?=$fila[33]?>">
          </div>
