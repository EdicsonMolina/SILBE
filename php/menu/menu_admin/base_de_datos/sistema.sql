...
--
-- Table structure for table `a_escolar`
--
...
CREATE TABLE `a_escolar` (
  `id_a` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `a` varchar(9) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id_a`)
...
LOCK TABLES `a_escolar` WRITE;
/*!40000 ALTER TABLE `a_escolar` DISABLE KEYS */;
INSERT INTO `a_escolar` VALUES ('1','1'),('2222','22222'),('A1617','2016-2017'),('Aasdasd','2222-2222');
...
CREATE TABLE `administrativo` (
  `ced_a` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `nombre` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `apellido` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sexo` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `edad` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `lugar_naci` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `f_naci` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `direc_hab` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tele_hab` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `tele_mov` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `deno_cargo` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cargo_fun` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `condicion_lab` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `codigo_cargo` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `tiempo_servicio` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `plantel_cobro` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `codigo_plantel` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `ingreso_minist` date NOT NULL,
  `clave_talon` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `clave_constancia` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `est_bachi` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `est_bachi_fe` date NOT NULL,
  `est_bachi_men` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `est_tsu` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `est_tsu_fe` date NOT NULL,
  `est_tsu_men` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `est_pre` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `est_pre_fe` date NOT NULL,
  `est_pre_men` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cursos` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `docente` (
  `ced_d` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `nombre` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `apellido` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sexo` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `edad` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `est_pre_fe` date NOT NULL,
  `est_pre_men` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `est_espe` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `est_espe_fe` date NOT NULL,
  `est_espe_men` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `est_ma` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `est_ma_fe` date NOT NULL,
  `est_ma_men` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `est_doc` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `est_doc_fe` date NOT NULL,
  `est_doc_men` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cursos` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `deno_cargo` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cargo_fun` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `condicion_lab` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `secciones` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `tiempo_servicio` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `turno` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `horas` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `plantel_cobro` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `codigo_plantel` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `plantel_otro` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `codigo_plantel_otro` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `horas_otro` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `ingreso_minist` date NOT NULL,
  `clave_talon` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `clave_costancia` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`ced_d`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `estado` (
  ...
  CONSTRAINT `estado_ibfk_1` FOREIGN KEY (`ubicacionpaisid`) REFERENCES `pais` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `estudiante` (
  `ced_e` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `ced_r` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tipo_doc` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `nombre` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `apellido` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `edad` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `sexo` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `edo_civil` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `lateralidad` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `pais` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `edo` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `area_aten` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `progra_apoy` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `muni` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `parro` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `pobla` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `urbani` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `via` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `direc` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `zona` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `tip_vivi` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `ubi_vivi` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `esta_infra` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `cond_vivi` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `canaima` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `beca` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `peso` float NOT NULL,
  `talla_cami` varchar(3) COLLATE utf8_unicode_ci NOT NULL,
  `talla_pant` varchar(3) COLLATE utf8_unicode_ci NOT NULL,
  `talla_zapa` varchar(3) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`ced_e`),
  KEY `ced_r` (`ced_r`),
  CONSTRAINT `estudiante_ibfk_1` FOREIGN KEY (`ced_r`) REFERENCES `representante` (`ced_r`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `grado` (
  `id_grado` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `nombre` varchar(7) COLLATE utf8_unicode_ci NOT NULL,
  `cod` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `grado_seccion` (
  `id_gs` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `id_grado` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `id_seccion` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id_gs`),
...
CREATE TABLE `mantenimiento` (
  `ced_m` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `nombre` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `apellido` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sexo` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `edad` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `mantenimiento` VALUES ('11111112','11','1','m','1','1','2017-01-05','1','1','1','1','1','1','f','1','1','1','1','2017-01-04','1','1','1','2017-01-03','1','1','0000-00-00','','','0000-00-00','','1');
...
CREATE TABLE `matricula` (
  `id_matri` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `id_a` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `ced_e` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `municipio` VALUES (1,'Alberto Adriani'),(2,'Antonio Pinto Salinas'),(3,'Andrés Bello'),(4,'Aricagua'),(5,'Arzobispo Chacón'),(6,'Campo Elías'),(7,'Caracciolo Parra Olmedo'),(8,'Cardenal Quintero'),(9,'Guáraque'),(10,'Julio César Salas'),(11,'Justo Briceño'),(12,'Libertador'),(13,'Miranda'),(14,'Obispo Ramos de Lora'),(15,'Padre Noguera'),(16,'Pueblo Llano'),(17,'Rangel'),(18,'Rivas Dávila'),(19,'Santos Marquina'),(20,'Sucre'),(21,'Tovar'),(22,'Tulio Febres Cordero'),(23,'Zea');
...
CREATE TABLE `parroquia` (
  ...
  CONSTRAINT `parroquia_ibfk_1` FOREIGN KEY (`id_municipio`) REFERENCES `municipio` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `parroquia` VALUES (1,1,'Presidente Betancourt (El Vigía)'),(2,1,'Presidente Páez (El Vigía)'),(3,1,'Presidente Rómulo Gallegos (El Vigía)'),(4,1,'Gabriel Picón González (La Palmita)'),(5,1,'Héctor Amable Mora (Mucujepe)'),(6,1,'José Nucete Sardi (Los Naranjos)'),(7,1,'Pulido Méndez (La Blanca)'),(8,2,'Santa Cruz de Mora (Santa Cruz de Mora)'),(9,2,'Mesa Bolívar (Mesa Bolívar)'),(10,2,'Mesa de Las Palmas (Mesa de Las Palmas)'),(11,3,'La Azulita (La Azulita)'),(12,4,'Aricagua (Aricagua)'),(13,4,'San Antonio (Campo Elías)'),(14,5,'Canaguá (Canaguá)'),(15,5,'Capurí (Capurí)'),(16,5,'Chacantá (Chacantá)'),(17,5,'El Molino (El Molino)'),(18,5,'Guaimaral (El Viento)'),(19,5,'Mucutuy (Mucutuy)'),(20,5,'Mucuchachí (Mucuchachí)'),(21,6,'Fernández Peña (Ejido)'),(22,6,'Matriz (Ejido)'),(23,6,'Montalbán (Ejido)'),(24,6,'Acequias (Acequias)'),(25,6,'Jají (Jají)'),(26,6,'La Mesa (La Mesa)'),(27,6,'San José del Sur (San José)'),(28,7,'Tucaní (Tucaní)'),(29,7,'Florencio Ramírez (El Pinar)'),(30,8,'Santo Domingo (Santo Domingo)'),(31,8,'Las Piedras (Las Piedras)'),(32,9,'Guáraque (Guáraque)'),(33,9,'Mesa de Quintero (Mesa de Quintero)'),(34,9,'Río Negro (Río Negro)'),(35,10,'Arapuey (Arapuey)'),(36,10,'Palmira (San José de Palmira)'),(37,11,'San Cristóbal de Torondoy (San Cristóbal de Torond'),(38,11,'Torondoy (Torondoy)'),(39,12,'Antonio Spinetti Dini (Mérida)'),(40,12,'Arias (Mérida)'),(41,12,'Caracciolo Parra Pérez (Mérida)'),(42,12,'Domingo Peña (Mérida)'),(43,12,'El Llano (Mérida)'),(44,12,'Gonzalo Picón Febres (Mérida)'),(45,12,'Jacinto Plaza (Mérida)'),(46,12,'Juan Rodríguez Suárez (Mérida)'),(47,12,'Lasso de la Vega (Mérida)'),(48,12,'Mariano Picón Salas (Mérida)'),(49,12,'Milla (Mérida)'),(50,12,'Osuna Rodríguez (Mérida)'),(51,12,'Sagrario (Mérida)'),(52,12,'El Morro (El Morro)'),(53,12,'Los Nevados (Los Nevados)'),(54,13,'Andrés Eloy Blanco (Chachopo)'),(55,13,'La Venta (La Venta)'),(56,13,'Piñango (Piñango)'),(57,13,'Timotes (Timotes)'),(58,14,'Eloy Paredes (Guayabones)'),(59,14,'San Rafael de Alcázar (San Rafael de Alcázar)'),(60,14,'Santa Elena de Arenales (Santa Elena de Arenales)'),(61,15,'Santa María de Caparo (Santa María de Caparo)'),(62,16,'Pueblo Llano (Pueblo Llano)'),(63,17,'Cacute (Cacute)'),(64,17,'La Toma (La Toma)'),(65,17,'Mucuchíes (Mucuchíes)'),(66,17,'Mucurubá (Mucurubá)'),(67,17,'San Rafael (San Rafael de Mucuchíes)'),(68,18,'Gerónimo Maldonado (La Playa)'),(69,18,'Bailadores (Bailadores)'),(70,19,'Tabay (Tabay)'),(71,20,'Chiguará (Chiguará)'),(72,20,'Estánquez (Estánquez)'),(73,20,'Lagunillas (Lagunillas)'),(74,20,'La Trampa (La Trampa)'),(75,20,'Pueblo Nuevo del Sur (Pueblo Nuevo del Sur)'),(76,20,'San Juan (San Juan de Lagunillas)'),(77,21,'El Amparo (El Amparo)'),(78,21,'El Llano (Tovar)'),(79,21,'San Francisco (San Francisco y Tovar)'),(80,21,'Tovar (Tovar)'),(81,22,'Independencia (Palmarito)'),(82,22,'María de la Concepción Palacios Blanco (Las Virtud'),(83,22,'Nueva Bolivia (Nueva Bolivia)'),(84,22,'Santa Apolonia (Santa Apolonia)'),(85,23,'Caño El Tigre (Caño Tigre)'),(86,23,'Zea (Zea)');
...
CREATE TABLE `representante` (
  `ced_r` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `tipo_doc` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `nombre` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `apellido` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sexo` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `edo_civil` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `afinidad` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `pais` int(11) NOT NULL,
  `edo` int(11) NOT NULL,
  `muni` int(2) NOT NULL,
  `parro` int(2) NOT NULL,
  `pobla` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `urbani` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `via` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `direc` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tele_mov` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `tele_hab` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `tele_trab` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(40) COLLATE utf8_unicode_ci NOT NULL,
  `direc_trab` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `nombre_empre` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  ...
  KEY `muni` (`muni`),
  KEY `parro` (`parro`),
  CONSTRAINT `representante_ibfk_1` FOREIGN KEY (`pais`) REFERENCES `pais` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `representante_ibfk_2` FOREIGN KEY (`edo`) REFERENCES `estado` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `representante_ibfk_3` FOREIGN KEY (`muni`) REFERENCES `municipio` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `representante_ibfk_4` FOREIGN KEY (`parro`) REFERENCES `parroquia` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `representante` VALUES ('5512963','v','Gilia del Carmen','Roman de Molina','f','c','m',95,1855,1,3,'Caño Amarillo','Caño Amarillo','carretera','Caño Amarillo vía panamericana ','04147572383','00000000000','00000000000','gilia_roman@gmail.com','La Blnca','La Blanca','Docente');
...
CREATE TABLE `seccion` (
  `id_seccion` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `nombre` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `cod` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `usuarios` VALUES ('Edicson Molin','edicson','$2y$10$1PIf2lbM0JzmzWrh8/7fR.ORw3SSnkCGvIbBChWIROQwCcbFgoKBS','1'),('Nelson Molina','nelson','afc0a762ff45348639901afc1ac3701c','2');
...
-- Dump completed on 2017-11-13 14:24:41
