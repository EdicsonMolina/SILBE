...
<script type='text/javascript'>
    ...
    window.location='administrador.php?p=mantenimiento/modificar_a_a';
</script>
<?php
} 
else {
...
<legend><h3 class="text-center"><b>MODIFICAR PERSONAL MANTENIMIENTO</b></h3></legend>
<form action="administrador.php?p=mantenimiento/modificar_M_c" autocomplete="off" method="POST" >

    <div class="container">
      <div class="row">
        <div class="col-xs-2">
            <label for="cédula">Cédula</label>
            <input name="ced_m" id="ced_m" type="text" maxlength="8" class="form-control input-sm" placeholder="Cedula" title="Cedila" pattern="[0-9]{7,8}$" required oninput="check_ced_r(this);" value="<?=$fila[0]?>">
          </div>
