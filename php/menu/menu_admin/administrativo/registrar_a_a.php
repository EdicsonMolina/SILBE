<legend><h3 class="text-center"><b>REGISTRAR PERSONAL ADMINISTRATIVO</b></h3></legend>
<form action="administrador.php?p=administrativo/registrar_a_b" autocomplete="off" method="POST" >

    <div class="container">
      <div class="row">
        <div class="col-xs-2">
            <label for="cédula">Cédula</label>
            <input name="ced_a" id="ced_a" type="text" maxlength="8" class="form-control input-sm" placeholder="Cedula" title="Cedila" pattern="[0-9]{7,8}$" required oninput="check_ced_r(this);">
          </div>
