...
<div class="container">
  <div class="row">
   <div class="col-md-12 col-md-offset-4">     
      <form class="navbar-form navbar-left" role="search" name="formulario" method="POST" action="administrador.php?p=administrativo/modificar_a_b">
        <div class="form-group">
            ...
            <button type="submit" class="btn btn-default" title="Buscar Personal Administrativo" >Buscar</button>
      </form>
  </div>
  </div>
</div>